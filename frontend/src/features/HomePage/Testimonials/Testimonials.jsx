        ...
        <div className="testimonials-content">
          <div className="section-t text-center">
            ...
            <p className="text">
              ...
              with BestInvest. Discover how our AI-driven solutions have
              empowered them to make informed financial decisions and achieve
              their investment goals with confidence.
            </p>
          </div>
