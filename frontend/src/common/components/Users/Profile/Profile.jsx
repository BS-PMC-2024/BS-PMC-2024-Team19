...
const Profile = () => {
    ...
    const fetchUserStatus = async () => {
      try {
        const response = await axios.get(
          "http://localhost:6500/backend/user/status",
  ...
  const handleUpdateEmail = async () => {
    try {
      await axios.post(
        "http://localhost:6500/backend/user/updateEmail",
        { email },
        { withCredentials: true }
      );
  ...
  const handleUpdatePassword = async () => {
    try {
      await axios.post(
        "http://localhost:6500/backend/user/updatePassword",
        { password },
        { withCredentials: true }
      );
              ...
              {isPremium ? (
                <>
                  <Typography
                    ...
                    className="text-capitalize"
                  >
                    You are a premium user. You can cancel your premium
                    membership below.
                  </Typography>
                  <Button
                    variant="contained"
                ...
                <>
                  <Typography
                    ...
                    className="text-capitalize"
                  >
                    Upgrade to Premium to unlock all features and enjoy a
            ...
            <Dialog open={open} onClose={handleCloseDialog}>
              ...
              <DialogContent>
                <DialogContentText>
                  ...
                  cannot be undone. Please type DELETE to confirm.
                </DialogContentText>
                <TextField
                  autoFocus
                  margin="dense"
